...
public class ChessGame {
    ...
    public static void main(String[] args) throws IOException {
      ...
      //importing images from file expoler
        
        BufferedImage all=ImageIO.read(new File("C:\\\\Users\\\\satyam gupta\\\\Downloads\\\\chess.png"));
        Image imgs[]=new Image[12]; //to take images
       int ind=0;
       ...
       ind++;
        ...
        //taking pyda from chess file and using in app
        
        // true for white pyda and false for black
        ...
        frame.setUndecorated(true);  //removing corner button
        JPanel pn=new JPanel(){
        	
        	
            @Override
            public void paint(Graphics g) {
            	//x for horizantal line
				//y for vertical line
            	
            	
            boolean white=true;
                for(int y= 0;y<8;y++){ //creating 8 black and 8 white box
                	
                	
            for(int x= 0;x<8;x++){ //creating 8 black and 8 white box
            	
                if(white){  //decinding color of chess board
